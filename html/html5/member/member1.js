...
$(document).ready(function () {
    ...
    //by hyun
    //jQuery 이벤트로 변경
    regForm.submit(function () {//등록을 누르면
        // 데이터 받아서 객체 생성
    ...
    resetBtn.click(function () {
        epw.val(members[index.val()].pw)// = members[index.val()].pw;
        erepw.val(members[index.val()].pw);// = members[index.val()].pw;
        //eid.value=members[index.value].userId;
        ename.val(members[index.val()].userName)// = members[index.val()].userName;
    });
