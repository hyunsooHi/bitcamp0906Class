...
public class FriendInfoHandler {
	...
	// 배열에 데이터를 저장하고
	// 데이터를 출력하는
	// 배열에저장된정보 데이터들을 출력하는 메소드

	// 다형성을 이용한 배열 정의
	private Friend[] friends;
	private int numOfFriends;// 입력된친구정보의개수,배열의index로 사용
	...
	void addFriendInfo(Friend f) {
		// 다형성 이용 > 매개변수의 선언은 상위타입의 클래스 타입으로
	...
	// 데이터를 사용자로부터 입력받아
	// Friend 클래스의 파생 클래스의 인스턴스를 생성 > addFriendInfo(f) 호출 해주는 메소드
	public void addFriend(int select) {
		...
		// select == 1 > 고교친구 정보 추가 정보를 받고 > 인스턴스 생성
		// select == 2 > 대학친구정보 추가 정보를 받고 > 인스턴스생성
	...
	public void showAllData() {
		System.out.println("친구정보를 모두출력합니다");
		System.out.println("==========================");
	...
	public void ShowAllSimpleData() {
		System.out.println("친구정보의 기본정보를 모두출력합니다");
		System.out.println("==========================");
		for (int i = 0; i < numOfFriends; i++) {
